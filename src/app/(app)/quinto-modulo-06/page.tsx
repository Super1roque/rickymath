...
export default function QuintoModulo06() {
  ...
  function comprobarItem(p: ItemPorcentaje, boton: HTMLButtonElement) {
  ...
  function comprobarDescuento(boton: HTMLButtonElement) {
    ...
    if (correcto) { reproducirCorrecto(); disparar(`Ahorra ${DESCUENTO.ahorra}, paga ${DESCUENTO.paga}`, boton.getBoundingClientRect()) } else reproducirIncorrecto()
    registrarResultado(correcto)
    reaccionarRicky(correcto)
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '1.5rem 1rem' }}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          <TarjetaDescuento estado={descuento} color={COLORES[4 % COLORES.length]}
            ...
            onComprobar={boton => comprobarDescuento(boton)} onExplicarEstado={reaccionarRickyExplicar} />
        </div>
