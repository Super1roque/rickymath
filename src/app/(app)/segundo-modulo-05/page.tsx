...
export default function SegundoModulo05() {
  ...
  function comprobarItem(p: PreguntaDividir, boton: HTMLButtonElement) {
    ...
    if (correcto) { reproducirCorrecto(); disparar(String(p.dividendo / p.divisor), boton.getBoundingClientRect()) } else reproducirIncorrecto()
