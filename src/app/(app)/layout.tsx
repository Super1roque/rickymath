...
export default function AppGroupLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      {/* Nombre del padre + plan — esquina opuesta a los controles de
          arriba, para no competir con el header de cada módulo ni con el
          badge de perfil. */}
      <div style={{
        position: 'fixed', bottom: 12, left: 12, zIndex: 45,
