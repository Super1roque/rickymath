...
export default function QuintoModulo07() {
  ...
  function comprobarItem(p: ItemVolumen, boton: HTMLButtonElement) {
    ...
    if (correcto) { reproducirCorrecto(); disparar(`${volumenReal} bloques³`, boton.getBoundingClientRect()) } else reproducirIncorrecto()
