...
export default function SegundoModulo09() {
  ...
  function comprobarItem(p: PreguntaReloj, boton: HTMLButtonElement) {
    ...
    if (correcto) { reproducirCorrecto(); disparar(`${p.hora}:${String(p.minuto).padStart(2, '0')}`, boton.getBoundingClientRect()) } else reproducirIncorrecto()
