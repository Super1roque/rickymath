...
// ── Datos de la actividad (basados en la hoja "Tabla del 4", serie bonus
// "Tablas de Multiplicar"). La hoja trae la tabla completa (4×1 a 4×10) ya
...
const PRACTICA: ItemPractica[] = [
  { numero: 1, n: 2, resultado: BASE * 2 },
  { numero: 2, n: 5, resultado: BASE * 5 },
...
export default function TablasModulo04() {
  const { user } = useAuth()
  ...
  useEffect(() => {
    ...
    guardarProgresoModulo(user.uid, perfilActivo.id, 'tablas-modulo-04', {
  ...
  return (
    <div className={fuenteJuego.className} style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: '2.6rem', marginBottom: '0.3rem' }}>🪵4️⃣</div>
        <h1 style={{
      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '1.5rem 1rem' }}>
        ...
        <h2 style={{ fontSize: '1.3rem', fontWeight: 800, margin: '1.5rem 0 1rem', textAlign: 'center', color: '#451a03' }}>
          ✏️ Ahora vos
        </h2>
          ...
          <div style={{
            ...
            <p style={{ opacity: 0.75, marginBottom: '1.5rem', fontSize: '1rem', fontWeight: 600 }}>
              {totalCorrectas === TOTAL_PREGUNTAS
                ? '¡Perfecto! Dominás la tabla del 4 🎮'
...
// Fila de bloques contables — un cuadradito por unidad, hasta 40, para que
// se vea como en la hoja (troncos con el "4" adentro) sin depender de
// imágenes.
  ...
  return (
    <div style={{ display: 'flex', gap: 3, flexWrap: 'wrap' }}>
      {Array.from({ length: cantidad }, (_, i) => (
        <div key={i} style={{
          width: 15, height: 15, borderRadius: 4, background: COLOR, color: 'white',
          display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.52rem', fontWeight: 800,
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.6rem' }}>
        ...
        <p style={{ fontWeight: 800, fontSize: '1.05rem', margin: 0, flex: 1, color: '#451a03' }}>La tabla del {BASE}</p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
        {TABLA.map(f => (
          <div key={f.n} style={{
            ...
            <span style={{ fontWeight: 800, fontSize: '0.95rem', color: '#451a03', width: 78, flexShrink: 0 }}>
              {BASE} × {f.n} =
            </span>
...
function CajaTruco() {
  return (
    <div style={{
      ...
      <div style={{ flex: 1 }}>
        <p style={{ margin: '0 0 0.2rem', fontWeight: 800, color: '#451a03', fontSize: '0.95rem' }}>Truco</p>
        <p style={{ margin: 0, fontSize: '0.9rem', color: '#451a03', fontWeight: 600 }}>{TRUCO}</p>
      </div>
...
function TarjetaPractica({ p, estado, onCambiar, onComprobar, onExplicarEstado }: {
  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: '1.3rem', fontWeight: 800, margin: '0 0 0.5rem', color: '#451a03' }}>
        {BASE} × {p.n} =
      </p>
