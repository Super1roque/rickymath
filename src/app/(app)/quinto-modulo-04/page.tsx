...
export default function QuintoModulo04() {
  ...
  function comprobarItem(p: ItemFraccion, boton: HTMLButtonElement) {
    ...
    if (correcto) { reproducirCorrecto(); disparar(`${p.resNum}/${p.resDen}`, boton.getBoundingClientRect()) } else reproducirIncorrecto()
